        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          <ul className="navbar-nav me-auto mb-2 mb-lg-0">
            <li className="nav-item">
              {/* <Link className="nav-link active" aria-current="page" to="/"> //link tag used for not refreshing page
                Home
              </Link> */}
          ...
          <div className="d-flex">
            ...
            <div className="bg-secondary rounded mx-2" style={{height: '20px', width:'20px',cursor:'pointer'}} onClick={()=>{props.toggleMode('secondary')}} ></div>
            ...
            <div className="bg-info rounded mx-2" style={{height: '20px', width:'20px',cursor:'pointer'}} onClick={()=>{props.toggleMode('info')}} ></div>
